...
<body>
    ...
    <form action="calculate.php" method="POST">
        <table>
            ...
            <tr>
                <td><input type="radio" name="first1" value="1"></td>
                <td>1</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="2"></td>
                <td>2</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="3"></td>
                <td>3</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="4"></td>
                <td>4</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="5"></td>
                <td>5</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="6"></td>
                <td>6</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="7"></td>
                <td>7</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" id="#" value="8"></td>
                <td>8</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="9"></td>
                <td>9</td>
                <td>
            ...
            <tr>
                <td><input type="radio" name="first1" value="10"></td>
                <td>10</td>
                <td>
